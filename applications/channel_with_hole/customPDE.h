...
// Function to set the nucleation probability (in nucleation.h)
  ...
  double          u_max = userInputs.get_model_constant_double("u_max");
  scalarvalueType rho   = constV(userInputs.get_model_constant_double("rho"));
  scalarvalueType mu    = constV(userInputs.get_model_constant_double("mu"));
