  ...
  for (unsigned int i = 0; i < n_copies; i++)
    {
      ...
      scalarValue eq_n  = (n - user_inputs.temporal_discretization.dt * fnV);
      scalarGrad  eqx_n = (-user_inputs.temporal_discretization.dt * 2.0 * nx);
