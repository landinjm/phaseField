...
public:
    ...
    // All of the vectors of flags for what is needed for the postprocessing variables
    std::vector<bool> pp_need_value, pp_need_gradient, pp_need_hessian, pp_need_value_residual, pp_need_gradient_residual;
