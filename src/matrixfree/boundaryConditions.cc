...
// =================================================================================
// Methods to set Dirichlet BCs
// =================================================================================
template <int dim, int degree>
void MatrixFreePDE<dim, degree>::setDirichlet()
{
    // Check if any of the Dirichlet BCs if nonuniform
    bool field_has_nonuniform_Dirichlet_BCs = false;
    ...
    // Apply non-uniform Dirichlet BCs to the current field
