    ...
    const std::vector<bool> var_nucleates) const
{
    ...
    parameter_handler.declare_entry("Output file compression type", "none", dealii::Patterns::Selection("none|default|speed|size"), "Select output compression type: none|default|speed|size");
